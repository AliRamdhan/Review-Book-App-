<x-app-layout>
    <div class="w-full h-screen pt-8">
        ...
        @if ($author)
            <form action="{{ route('update.author', ['author' => $author->author_id]) }}" method="POST"
                    ...
                    <div class="w-full mb-0 mt-4 mx-8 flex flex-col items-center gap-4">
                        <div class="w-full flex justify-around">
                            <div class="w-full flex flex-col gap-4">
                                ...
                                <div class="w-full">
                                    <div>Description</div>
                                    <textarea type="text" name="authorDescription"
                                        class="w-full rounded-lg border-gray-200 p-2 text-sm shadow-sm border-2" rows="4">{{ $author->authorDescription }}</textarea>
                                </div>
                            </div>
                            <div class="w-full">
                                    <div class="w-full flex flex-col justify-center items-center">
                                        ...
                                        <div class="w-4/5 mb-3">
                                            @if ($author->authorImage)
                                                <div
                                                    class="w-full flex justify-around items-center border-2 rounded-lg">
                                                    <span class="text-lg font-bold text-gray-500 tracking-wide">Recent
                                                        Image</span>
                                                    <img src="{{ asset('storage/authors_image/' . $author->authorImage) }}"
                                                        alt="Author Image" class="w-24 h-24">
                                                </div>
                                            @else
                                                    ...
                                                    <div class="pointer-none text-gray-500">
                                                        ...
                                                        <div class="w-full flex justify-center items-center">
                                                            <div href="" id="fileUploadLabel"
                                                                ...
                                                                <input type="file" name="authorImage" class="w-56"
