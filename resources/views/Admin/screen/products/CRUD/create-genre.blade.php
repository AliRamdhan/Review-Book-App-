<x-app-layout>
    <div class="w-full h-screen pt-8">
        ...
        <form action="{{ route('create.genre') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="w-full mb-0 mt-4 mx-8 flex flex-col items-center gap-4">
                    ...
                    <div class="w-full">
                        <div class="w-full flex flex-col justify-center items-center">
                            <label class="w-full text-sm font-bold text-gray-500 tracking-wide">Attach
                                Document</label>
                                        ...
                                        <div class="pointer-none text-gray-500">
                                            ...
                                            <div class="w-full flex justify-center items-center">
                                                <div id="fileUploadLabel"
                                                    ...
                                                    <input type="file" name="genreImage" id=""
                                                        class="w-56">
                                                </div>
                                                from your computer
                                            </div>
