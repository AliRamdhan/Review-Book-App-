<x-client-layout>
    <div class="w-full flex flex-col items-center min-h-screen">
        <div class="w-full px-8 text-xl font-bold py-4 border-b-2 ">
            <div class="text-3xl font-semibold">Books All</div>
                ...
                <div class="swiper" style="height:40px">
                    <div class="swiper-wrapper w-full">
                        <div class="swiper-slide w-1/6">
                            <a href="{{ route('book.all') }}" class="w-full">
                        ...
                        <div
                            ...
                            <div class="w-full flex flex-col justify-center gap-1 px-2">
                                ...
                                <div class="font-medium"
                                    ...
                                    {{ $book->bookSynopsis }} Lorem ipsum dolor sit amet, consectetur adipisicing elit.
