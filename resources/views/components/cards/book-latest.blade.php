        ...
        <div class="swiper-slide w-52 mx-4">
            <a href="#">
                <div class="w-56 bg-white border border-gray-200 rounded-lg shadow-xl">
                    <img style="background-size: cover; object-position: center;" class="w-full h-56" src="image/login.png"
                        alt="product image" />
                    <div class="px-5">
                        <div class="text-base font-bold text-gray-600">
                            Romantic Books
                        </div>
                        <h5 class="text-lg font-semibold tracking-tight text-gray-900">Apple Watch Series 7 GPS</h5>
                        ...
                        <div class="flex items-center mt-2.5 mb-5">
                            ...
                            <span
                                class="text-xs font-semibold mr-2 px-2.5 rounded shadow-md hover:bg-gray-200 ml-3">5.0/5.0</span>
                        </div>
                    </div>
                </div>
            </a>
