...
<div class="w-1/5 relative inline-flex" x-data="{ open: false }">
    <button
    ...
    <div
        class="w-96 origin-top-right z-10 absolute top-full -mr-48 sm:mr-0 min-w-80 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1 {{$align === 'right' ? 'right-0' : 'left-0'}}"
