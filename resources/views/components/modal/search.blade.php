...
<div x-data="{ searchOpen: false }">
    ...
    >
        ...
        >
            <!-- Search form -->
            <form class="border-b border-slate-200" action="{{route('books.search')}}" method="GET">
                <div class="relative">
                    <label for="modal-search" class="sr-only">Search</label>
                    <input id="modal-search" class="w-full border-0 focus:ring-transparent placeholder-slate-400 appearance-none py-3 pl-10 pr-4" name="search" type="search" placeholder="Search Anything…" x-ref="searchInput" />
